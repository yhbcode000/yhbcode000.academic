...
- **R&D Lead**, ValveMind AI, Shanghai (2023.4–2024.4)
  - Led two 10-person teams on federated learning and privacy-preserving AI
- **Tech Lead**, ShellRabbit Tech, Beijing (2024.5–2024.10)
  - Developed AI-powered pet companion robot; secured seed funding
- **Subsidiary Prep Lead**, Mengshi Aviation, Abu Dhabi/Xiong'an (2025.1–2025.8)
...
- **AI/ML**: PyTorch, TensorFlow, SFT, instruction tuning, transfer learning, federated learning, RAG, agent tool-use, MCP, multi-agent systems
- **Robotics**: ROS/ROS2, RL, VLA models, Gazebo, MuJoCo, IsaacLab, Jetson Orin
- **Languages**: Python, C, Java, Haskell, SQL
- **Tools**: Docker, Git, Linux/WSL, Claude Code, Cursor
